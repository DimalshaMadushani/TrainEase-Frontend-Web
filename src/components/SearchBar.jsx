...
const SearchBar = ({ stations, onSearch, setFrom, setTo, setDate, initialSearchParams }) => {
  ...
  return (
    <Grid container spacing={2} alignItems="center">
      <Grid item xs={12} md={3}>
        <Box sx={{backgroundColor:'white', borderRadius: 1}}>
          <Autocomplete
            ...
            renderInput={(params) => <TextField {...params} label="From" variant="outlined" data-testid="from-input" />}
          />
        </Box>
      </Grid>
      <Grid item xs={12} md={3}>
        <Box sx={{backgroundColor:'white',borderRadius: 1}}>
          <Autocomplete
            ...
            renderInput={(params) => <TextField {...params} label="To" variant="outlined" data-testid="to-input" />}
          />
        </Box>
      </Grid>
      <Grid item xs={12} md={3}>
      ...
      <Grid item xs={12} md={3}>
        <Button variant="contained" color="secondary" fullWidth onClick={onSearch} sx={{py:1.7}} data-testid="search-button">
          Search
        </Button>
      </Grid>
    </Grid>
